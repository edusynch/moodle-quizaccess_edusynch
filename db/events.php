...
$observers = [
    [
        ...
        'callback' => 'quizaccess_edusyncheproctoring_attempt_viewed_handler',
        'internal' => false,
    ],
    [
    ...
    [
        ...
        'callback' => 'quizaccess_edusyncheproctoring_attempt_summary_viewed_handler',
        'internal' => false,
    ],        

    [
        'eventname' => 'mod_quiz\event\attempt_regraded',
        'callback' => 'quizaccess_edusyncheproctoring_attempt_regraded_handler',
        'internal' => false,
    ],     

    [
        'eventname' => 'mod_quiz\event\attempt_started',
        'callback' => 'quizaccess_edusyncheproctoring_attempt_started_handler',
        'internal' => false,
    ],     

    [
        'eventname' => 'mod_quiz\event\report_viewed',
        'callback' => 'quizaccess_edusyncheproctoring_report_viewed_handler',
        'internal' => false,
    ],      

    [
        'eventname' => 'mod_quiz\event\course_module_instance_list_viewed',
        'callback' => 'quizaccess_edusyncheproctoring_course_module_instance_list_viewed_handler',
        'internal' => false,
    ],      

    [
        'eventname' => 'mod_quiz\event\course_module_viewed',
        'callback' => 'quizaccess_edusyncheproctoring_course_module_viewed_handler',
        'internal' => false,
    ],      
    
    [
        'eventname' => 'mod_quiz\event\attempt_abandoned',
        'callback' => 'quizaccess_edusyncheproctoring_attempt_abandoned_handler',
        'internal' => false,
    ],         
