                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-8 d-flex text-dark">
                                ...
                                <div class="pl-5" id="reviewed-wrapper" data-url="<?php echo EPROCTORING_PATH ?>ajax.php?action=review&sessionid=<?php echo $session_details['id'] ?>&incident_level=<?php echo $session_details['incident_level'] ?>">
